...
# V2.0.5 : Change qml location
# V2.0.6 : Change ressources path for i18n
#-----------------------------------------------------------------------------------------------------------
...
class LiveScripting(Tool):
	def __init__(self):
		...
		try:
			self._script_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),'resources', 'plugin_scripts', 'live_script.py')
			self._scriptfolder = os.path.join(os.path.dirname(os.path.abspath(__file__)),'resources', 'plugin_scripts')
